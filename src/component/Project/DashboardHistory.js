    ...
    return (
      <>
        <div className="DAT_ProjectData_Dashboard_Filterlist_Body_Checkbox">
          ...
          />
          <label htmlFor={"productionData_" + projectData.value.plantmode}>
        ...
        <div className="DAT_ProjectData_Dashboard_Filterlist_Body_Checkbox">
          <input
            ...
            type="checkbox"
            defaultChecked={
              filterchart[projectData.value.plantmode][dateType].consumptionData
            }
            onChange={(e) => {
              handlefilterchart(e);
            }}
          />
          <label htmlFor={"consumptionData_" + projectData.value.plantmode}>
            {dataLang.formatMessage({
              id: "consumption",
            })}
          </label>
        ...
        <div className="DAT_ProjectData_Dashboard_Filterlist_Body_Checkbox">
          <input
            ...
            type="checkbox"
            defaultChecked={
              filterchart[projectData.value.plantmode][dateType].dailygridin
            }
            onChange={(e) => {
              handlefilterchart(e);
            }}
        ...
        <div className="DAT_ProjectData_Dashboard_Filterlist_Body_Checkbox">
          <input
            ...
            type="checkbox"
            defaultChecked={
              filterchart[projectData.value.plantmode][dateType].dailygridout
            }
            onChange={(e) => {
              handlefilterchart(e);
            }}
            ...
            {(() => {
              switch (projectData.value.plantmode) {
                case "consumption":
                  ...
                  //
                  //         <td className="DAT_ProjectData_NewDashboard_History_SubConfig_Dropdown_Item_Table_Tr_Td">
                  //           <div className="DAT_ProjectData_NewDashboard_History_SubConfig_Dropdown_Item_Table_Tr_Td_Checkbox">
                  //             <input
                  //               id={
                  //                 "productionData_" +
                  ...
                  return (
                    <>
                      ...
                      <div className="DAT_ProjectData_NewDashboard_Filterlist_Body_Checkbox">
                        ...
                        <label
                          htmlFor={
                            "dailygridout_" + projectData.value.plantmode
                          }
                        >
                          {dataLang.formatMessage({
                            id: "purchaseE",
                      ...
                      <div className="DAT_ProjectData_NewDashboard_Filterlist_Body_Checkbox">
                        ...
                        />
                        <label
                          htmlFor={"charge_" + projectData.value.plantmode}
                        >
                          {dataLang.formatMessage({
                            id: "charge",
                          })}
                ...
                case "grid":
                  switch (dateType) {
                    case "date":
                      return <CheckboxGrid></CheckboxGrid>;
                    case "month":
                      return <CheckboxGrid></CheckboxGrid>;
                    case "year":
                      return <CheckboxGrid></CheckboxGrid>;
        ...
        <div className="DAT_ProjectData_NewDashboard_History">
          <div className="DAT_ProjectData_NewDashboard_History_Tit">
            ...
            <div className="DAT_ProjectData_NewDashboard_History_Tit_Right">
              ...
              {/* 
            <div className="DAT_ProjectData_NewDashboard_History_Tit_Right_Config">
              <button
                onClick={(e) => {
                  handleShowConfig(e);
          ...
          <div
            className="DAT_ProjectData_NewDashboard_History_SubConfig"
            style={{
          ...
          >
            {dropConfig ? (
              <div
                className="DAT_ProjectData_NewDashboard_History_SubConfig_Dropdown"
                style={{
