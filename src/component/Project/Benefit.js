...
import { coalsave, projectdatasize } from "./ProjectData";
                            ...
                            <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col">
                                <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item">
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Icon">
                                        ...
                                        <img src="/dat_icon/3_Icon_AppEmbody-05.png" alt="" style={{ width: projectdatasize.value.icon.fontSize, height: projectdatasize.value.icon.fontSize }} />
                                    </div>
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container">
                                        <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container_Tit"
                                            style={{ fontSize: projectdatasize.value.label.fontSize, color: COLOR.value.grayText }}
                                        >
                                        ...
                                        &nbsp;
                                        <span>t</span> */}
                                            <span style={{ fontSize: projectdatasize.value.value.fontSize }}>
                                                {Number(
                                                    parseFloat(
                                                        coalsave.value.value * coalsave.value.ef || 0
                                                    ).toFixed(1)
                                            ...
                                            &nbsp;
                                            <span
                                                style={{ color: COLOR.value.grayText, fontSize: projectdatasize.value.unit.fontSize }}
                                            >
                                                t
                                            </span>
                                        </div>
                                ...
                                <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item">
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Icon">
                                        ...
                                        <img src="/dat_icon/3_Icon_AppEmbody-06.png" alt="" style={{ width: projectdatasize.value.icon.fontSize, height: projectdatasize.value.icon.fontSize }} />
                                    </div>
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container">
                                        <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container_Tit"
                                            style={{ fontSize: projectdatasize.value.label.fontSize, color: COLOR.value.grayText }}
                                ...
                                <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item">
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Icon">
                                        ...
                                        <img src="/dat_icon/3_Icon_AppEmbody-08.png" alt="" style={{ width: projectdatasize.value.icon.fontSize, height: projectdatasize.value.icon.fontSize }} />
                                    </div>
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container">
                                        <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container_Tit"
                                            style={{ fontSize: projectdatasize.value.label.fontSize, color: COLOR.value.grayText }}
                                ...
                                <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item">
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Icon">
                                        ...
                                        <img src="/dat_icon/3_Icon_AppEmbody-07.png" alt="" style={{ width: projectdatasize.value.icon.fontSize, height: projectdatasize.value.icon.fontSize }} />
                                    </div>
                                    <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container">
                                        <div className="DAT_ProjectData_NewDashboard_More_Right_Content_Col_Item_Container_Tit"
                                            style={{ fontSize: projectdatasize.value.label.fontSize, color: COLOR.value.grayText }}
