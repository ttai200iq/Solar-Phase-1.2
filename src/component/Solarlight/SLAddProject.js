...
import { slPlantState, slprojectlist } from "./SLProjectlist";

const plantData = signal({
  addr: "",
  angle: "",
  business: "",
  capacity: "",
...
export default function SLAddProject(props) {
  const dataLang = useIntl();
    ...
    if (check !== 0) {
      ...
      const addProject = async () => {
        ...
        if (d.status === true) {
          ...
          slprojectlist.value = [...slprojectlist.value, d.data];
