...
import { slPlantState, slProjectData, slprojectlist } from "./SLProjectlist";
...
const BasicInfo = (props) => {
  ...
  const handleBasic = (e) => {
    slProjectData.value[e.currentTarget.id] = e.currentTarget.value;
  };
  ...
  const initMap = async (name, lat, long) => {
    ...
    loader.load().then(async (google) => {
      ...
      map.addListener("click", (mapsMouseEvent) => {
        ...
        const index = slprojectlist.value.findIndex(
          (item) => item.plantid_ === parseInt(slProjectData.value.plantid_)
        )
        slprojectlist.value[index] = {
          ...slprojectlist.value[index],
          lat: mapsMouseEvent.latLng.toJSON().lat,
          long: mapsMouseEvent.latLng.toJSON().lng
        }
            ...
            <div className="DAT_EditProject_BasicInfo_Body_Left">
              <div className="DAT_EditProject_BasicInfo_Body_Left_Item">
                ...
                <input
                  id="plantname"
                  type="text"
                  defaultValue={slProjectData.value.plantname}
              ...
              <div className="DAT_EditProject_BasicInfo_Body_Left_Item">
                ...
                {/* <input
                  id="addr"
                  type="text"
                  defaultValue={slProjectData.value.addr}
                  onChange={(e) => handleBasic(e)}
                /> */}

                <label htmlFor="copy-button" style={{ display: "flex", position: 'relative', alignItems: "center", gap: "5px", cursor: "pointer" }}>
                  <input name="copy-button" aria-label="copy-button" id="addr" type="text" defaultValue={slProjectData.value.addr} style={{ padding: '5px' }} onChange={(e) => handleBasic(e)} />
                ...
                <div className="DAT_EditProject_BasicInfo_Body_Left_Item_Posi">
                  <div className="DAT_EditProject_BasicInfo_Body_Left_Item_Posi_Content">
                    ...
                    <input
                      id="long"
                      type="text"
                      defaultValue={slProjectData.value.long}
                      disabled
                    // onChange={(e) => handleBasic(e)}
                  ...
                  <div className="DAT_EditProject_BasicInfo_Body_Left_Item_Posi_Content">
                    ...
                    <input
                      id="lat"
                      type="text"
                      defaultValue={slProjectData.value.lat}
                      disabled
                    // onChange={(e) => handleBasic(e)}
                    // onClick={(e) => handleMap(e)}
                    />
...
const SystemInfo = (props) => {
  ...
  const handleDate = (e) => {
    slProjectData.value[e.currentTarget.id] = moment(
      e.currentTarget.value
    ).format("MM/DD/YYYY");
  };

  useEffect(() => {
    slProjectData.value["griddate"] = moment(new Date()).format("MM/DD/YYYY");
  }, []);
          ...
          <div className="DAT_EditProject_SystemInfo_Body">
            <div className="DAT_EditProject_SystemInfo_Body_Left">
              <div className="DAT_EditProject_SystemInfo_Body_Left_Item">
                ...
                <select
                  id="planttype"
                  defaultValue={slProjectData.value.planttype}
              ...
              <div className="DAT_EditProject_SystemInfo_Body_Left_Item">
                ...
                <select
                  id="plantmode"
                  defaultValue={slProjectData.value.plantmode}
                  onChange={(e) => handleSystem(e)}
                >
                  <option value="grid">
            ...
            <div className="DAT_EditProject_SystemInfo_Body_Center">
              <div className="DAT_EditProject_SystemInfo_Body_Center_Item">
                ...
                <input
                  id="capacity"
                  type="number"
                  defaultValue={slProjectData.value.capacity}
                  onChange={(e) => handleSystem(e)}
                />
              </div>
              ...
              <div className="DAT_EditProject_SystemInfo_Body_Center_Item">
                ...
                <input
                  id="griddate"
                  type="date"
                  defaultValue={moment(slProjectData.value.griddate).format(
                    "YYYY-MM-DD"
                  )}
            ...
            <div className="DAT_EditProject_SystemInfo_Body_Right">
              <div className="DAT_EditProject_SystemInfo_Body_Right_Item">
                ...
                <input
                  id="angle"
                  type="number"
                  defaultValue={slProjectData.value.angle}
                  onChange={(e) => handleSystem(e)}
                />
              </div>
            </div>
          ...
          <div className="DAT_EditProject_YieldInfo_Body">
            <div className="DAT_EditProject_YieldInfo_Body_Left">
              <div className="DAT_EditProject_YieldInfo_Body_Left_Item">
                ...
                <select
                  id="currency"
                  defaultValue={slProjectData.value.currency}
            ...
            <div className="DAT_EditProject_YieldInfo_Body_Center">
              <div className="DAT_EditProject_YieldInfo_Body_Center_Item">
                ...
                <input
                  id="price"
                  type="number"
                  defaultValue={slProjectData.value.price}
                  onChange={(e) => handleYield(e)}
                />
              </div>
            </div>
            ...
            <div className="DAT_EditProject_OwnerInfo_Body_Left">
              <div className="DAT_EditProject_OwnerInfo_Body_Left_Item">
                ...
                <input
                  id="contact"
                  type="text"
                  defaultValue={slProjectData.value.contact}
            ...
            <div className="DAT_EditProject_OwnerInfo_Body_Center">
              <div className="DAT_EditProject_OwnerInfo_Body_Center_Item">
                ...
                <input
                  id="phone"
                  type="text"
                  defaultValue={slProjectData.value.phone}
                  onChange={(e) => handleOwner(e)}
                />
              </div>
            </div>
            ...
            <div className="DAT_EditProject_OwnerInfo_Body_Right">
              <div className="DAT_EditProject_OwnerInfo_Body_Right_Item">
                ...
                <input
                  id="business"
                  type="text"
                  defaultValue={slProjectData.value.business}
                  onChange={(e) => handleOwner(e)}
                />
              </div>
            </div>
...
const ImgInfo = (props) => {
  ...
  const handleChooseAvatar = async (e) => {
    ...
    // slProjectData.value[e.currentTarget.id] = e.current
    ...
    if (e.target.files[0].size > 50000) {
      ...
      reader.onload = () => {
        ...
        slProjectData.value.img = reader.result;
      };
    } else {
...
export default function SLEditProject(props) {
  const dataLang = useIntl();
  ...
  const handleSave = () => {
    var check = 0;
    Object.entries(slProjectData.value).map(([key, value]) => {
      if (slProjectData.value[key] === "") {
        check += 1;
      }
    });
    ...
    if (check !== 0) {
      ...
      const editProject = async () => {
        let d = await callApi("post", host.DATA + "/editPlant", {
          ...
          usr: props.usr,
          name: slProjectData.value.plantname,
          company: slProjectData.value.company,
          addr: slProjectData.value.addr,
          long: slProjectData.value.long,
          lat: slProjectData.value.lat,
          contact: slProjectData.value.contact,
          phone: slProjectData.value.phone,
          business: slProjectData.value.business,
          type: slProjectData.value.planttype,
          mode: slProjectData.value.plantmode,
          griddate: slProjectData.value.griddate,
          capacity: slProjectData.value.capacity,
          angle: slProjectData.value.angle,
          currency: slProjectData.value.currency,
          price: slProjectData.value.price,
          production: "0",
          power: "0",
          partnerid: userInfor.value.partnerid,
          usrtype: userInfor.value.type,
          img: slProjectData.value.img
            ? slProjectData.value.img
            : "/dat_picture/solar_panel.png",
        });
        if (d.status === true) {
        ...
        <div className="DAT_EditProject_Header_Right">
          ...
          <div className="DAT_EditProject_Header_Right_Close">
            <IoClose
              ...
              onClick={() => (slPlantState.value = "default")}
            />
          </div>
        </div>
      </div>
