...
export const messages = {
  en: {
    ...
    sologon: "Smart energy management system",
    version: "Version",
    previous: "Back",
    unknown: "--",
    active: "Active",
  ...
  vi: {
    ...
    dashboardMobile: "Trang chủ",
    maintain: "Vận hành-Bảo trì",
    maintainMobile: "Vận hành",
    analytic: "Phân tích",
    ...
    deviceTotal: "Tổng số thiết bị",
    ...
    unitPrice: "Đơn giá",
    C02: "CO₂ tiết giảm",
    cropYield: "Số cây trồng",
    tree: "cây",
    coalSave: "Than tiết giảm",
    frequency: "Tần suất",
    capacity: "Dung lượng",
    gridfeed: "Lấy vào",
    purchaseE: "Bán ra",
    ...
    version: "Phiên bản",
    sologon: "Giám sát năng lượng thông minh",
    previous: "Quay lại",
    unknown: "--",
